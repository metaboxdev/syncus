 ...
 */
            ...
            _update(t = Date.now()) {
                ...
                this._charts.forEach((i, s) => {
                    ...
                    let n = i.items
                        ...
                        , o = !1;
                    for (; r >= 0; --r)
                        (a = n[r])._active ? (a._total > i.duration && (i.duration = a._total),
                            a.tick(t),
        ...
        class l {
            constructor(t, e, i, a) {
                ...
                let r = (0,
                    s.a)([t.from, n, a]);
                this._active = !0,
                    this._fn = t.fn || o[t.type || typeof r],
            ...
            configure(t) {
                ...
                Object.getOwnPropertyNames(t).forEach(a => {
                    ...
                    for (let t of e)
                        r[t] = n[t];
                    ((0,
                        s.b)(n.properties) && n.properties || [a]).forEach(t => {
        ...
        function f(t, e) {
            ...
            for (let t = 0; t < u; ++t) {
                ...
                (i = (s._stacks || (s._stacks = {}))[d] = function (t, e, i) {
                    ...
                    i._top = p(i, o, !0, a.type),
                    i._bottom = p(i, o, !1, a.type),
        ...
        function x(t, e) {
            ...
            if (s)
                for (let a of e = e || t._parsed) {
                    let t = a._stacks;
                    if (!t || void 0 === t[s] || void 0 === t[s][i])
                        return;
                    delete t[s][i],
                        void 0 !== t[s]._visualValues && void 0 !== t[s]._visualValues[i] && delete t[s]._visualValues[i]
                }
        }
        ...
        class y {
            ...
            buildOrUpdateElements(t) {
                ...
                e._stacked = g(e.vScale, e),
                    ...
                    (s || a !== e._stacked) && f(this, e._parsed)
            }
            configure() {
            ...
            parse(t, e) {
                ...
                if (!1 === this._parsing)
                    ...
                    n = (0,
                        s.b)(o[t]) ? this.parseArrayData(r, o, t, e) : (0,
                            s.i)(o[t]) ? this.parseObjectData(r, o, t, e) : this.parsePrimitiveData(r, o, t, e);
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && r && (s.values = r,
                    n = u(s, a, this._cachedMeta.index)),
            ...
            getMinMax(t, e) {
                ...
                let n = this._cachedMeta
                    ...
                    , { min: u, max: g } = function (t) {
                        let { min: e, max: i, minDefined: s, maxDefined: a } = t.getUserBounds();
                        return {
                ...
                function p() {
                    let e = (a = r[i])[h.axis];
                    return !(0,
                        s.g)(a[t.axis]) || u > e || g < e
                }
                for (i = 0; i < l && (p() || (this.updateRangeFromParsed(c, t, a, d),
                    !o)); ++i)
                    ;
                if (o) {
                    for (i = l - 1; i >= 0; --i)
            ...
            _update(t) {
                ...
                this.update(t || "default"),
                    o._clip = (e = (0,
                        s.v)(this.options.clip, function (t, e, i) {
                            if (!1 === i)
                                return !1;
                            let s = d(t, i)
                                , a = d(e, i);
            ...
            draw() {
                ...
                for (s.dataset && s.dataset.draw(e, n, o, l),
                    t = o; t < o + l; ++t) {
                    let i = a[t];
            ...
            getContext(t, e, i) {
                ...
                if (t >= 0 && t < this._cachedMeta.data.length) {
                    ...
                    (o = e.$context || (e.$context = (a = this.getContext(),
                        (0,
                            s.j)(a, {
                                active: !1,
                                dataIndex: t,
                    ...
                    (o = this.$context || (this.$context = (n = this.chart.getContext(),
                        r = this.index,
                        (0,
                            s.j)(n, {
                                active: !1,
            ...
            _resolveElementOptions(t, e = "default", i) {
                ...
                return p.$shared && (p.$shared = l,
                    n[r] = Object.freeze(_(p, l))),
                    p
            }
            _resolveAnimations(t, e, i) {
                ...
                return s && s._cacheable && (n[r] = Object.freeze(l)),
                    l
            }
            getSharedOptions(t) {
                if (t.$shared)
            ...
            _resyncElements(t) {
                ...
                for (let [t, e, i] of this._syncList)
                    this[t](e, i);
                this._syncList = [];
                let s = i.length
                    , a = e.length
        ...
        class P extends y {
            ...
            getLabelAndValue(t) {
                let { iScale: e, vScale: i } = this._cachedMeta
                    , s = this.getParsed(t)
                    , a = s._custom
                    , n = k(a) ? "[" + a.start + ", " + a.end + "]" : "" + i.getLabelForValue(s[i.axis]);
                return {
            ...
            updateElements(t, e, i, a) {
                let n = "reset" === a
                    , { index: r, _cachedMeta: { vScale: o } } = this
                    , l = o.getBasePixel()
                    , h = o.isHorizontal()
                    , d = this._getRuler()
                ...
                for (let g = e; g < e + i; g++) {
                    ...
                    !function (t, e, i, s) {
                        let a, n, r, o, l, h = e.borderSkipped, d = {};
                        if (!h) {
                            t.borderSkipped = d;
                            return
                        }
                        ...
                        let { start: c, end: u, reverse: g, top: p, bottom: f } = (t.horizontal ? (a = t.base > t.x,
                            n = "left",
                            r = "right") : (a = t.base < t.y,
                                n = "bottom",
                                r = "top"),
                            a ? (o = "end",
                                l = "start") : (o = "start",
                        ...
                        "middle" === h && i && (t.enableBorderRadius = !0,
                            (i._top || 0) === s ? h = p : (i._bottom || 0) === s ? h = f : (d[S(f, c, u, g)] = !0,
                                h = p)),
                            d[S(h, c, u, g)] = !0,
                            t.borderSkipped = d
                    }(m, x, f, r),
            ...
            _getStacks(t, e) {
                let { iScale: i } = this._cachedMeta
                    , a = i.getMatchingVisibleMetas(this._type).filter(t => t.controller.options.grouped)
                    , n = i.options.stacked
                    , r = []
                    , o = t => {
                    ...
                    ;
                for (let i of a)
                    if (!(void 0 !== e && o(i)) && ((!1 === n || -1 === r.indexOf(i.stack) || void 0 === n && void 0 === i.stack) && r.push(i.stack),
                        i.index === t))
                        break;
                return r.length || r.push(void 0),
                    r
            }
            _getStackCount(t) {
                ...
                return {
                    min: o || function (t) {
                        ...
                        let r = t.iScale
                            ...
                            , h = () => {
                                32767 !== a && -32768 !== a && ((0,
                                    s.h)(n) && (l = Math.min(l, Math.abs(a - n) || l)),
                                    n = a)
                            }
                            ;
                        for (e = 0,
                            i = o.length; e < i; ++e)
                            a = r.getPixelForValue(o[e]),
                                h();
                        for (e = 0,
                            n = void 0,
                            i = r.ticks.length; e < i; ++e)
                            a = r.getPixelForTick(e),
                                h();
                        return l
                    }(a),
                    pixels: r,
            ...
            _calculateBarValuePixels(t) {
                let e, i;
                let { _cachedMeta: { vScale: a, _stacked: n, index: r }, options: { base: o, minBarLength: l } } = this
                    , h = o || 0
                    , d = this.getParsed(t)
                    , c = d._custom
                    , u = k(c)
                ...
                if (Math.abs(i = (e = this.chart.getDataVisibility(t) ? a.getPixelForValue(p + f) : x) - x) < l) {
                    var b;
                    i = (0 !== (b = i) ? (0,
                        s.s)(b) : (a.isHorizontal() ? 1 : -1) * (a.min >= h ? 1 : -1)) * l,
                        g === h && (x -= i / 2);
                    let t = a.getPixelForDecimal(0)
                        , o = a.getPixelForDecimal(1);
                    e = (x = Math.max(Math.min(x, Math.max(t, o)), Math.min(t, o))) + i,
                        n && !u && (d._stacks[a.axis]._visualValues[r] = a.getValueForPixel(e) - a.getValueForPixel(x))
                }
                if (x === a.getPixelForValue(h)) {
                    let t = (0,
                        s.s)(i) * a.getLineWidthForValue(h) / 2;
                    x += t,
                        i -= t
                }
                return {
                ...
                if (e.grouped) {
                    let n = o ? this._getStackCount(t) : e.stackCount
                        , h = "flex" === r.barThickness ? function (t, e, i, s) {
                            ...
                            let o = i.barThickness;
                            return (0,
                                s.k)(o) ? (n = e.min * i.categoryPercentage,
                                    r = i.barPercentage) : (n = o * a,
                                        r = 1),
                            {
                                chunk: n / a,
                                ratio: r,
        ...
        class C extends y {
            ...
            parseArrayData(t, e, i, a) {
                ...
                for (let t = 0; t < n.length; t++) {
                    let a = e[i + t];
                    n[t]._custom = (0,
                        s.v)(a[2], this.resolveDataElementOptions(t + i).radius)
                }
                return n
            }
            parseObjectData(t, e, i, a) {
                ...
                for (let t = 0; t < n.length; t++) {
                    let a = e[i + t];
                    n[t]._custom = (0,
                        s.v)(a && a.r && +a.r, this.resolveDataElementOptions(t + i).radius)
                }
                return n
            }
            getMaxOverflow() {
            ...
            updateElements(t, e, i, s) {
                let a = "reset" === s
                    ...
                    , { sharedOptions: o, includeOptions: l } = this._getSharedOptions(e, s)
                    , h = n.axis
                    , d = r.axis;
                for (let c = e; c < e + i; c++) {
                    let e = t[c]
                    ...
                    u.skip = isNaN(g) || isNaN(p),
                        l && (u.options = o || this.resolveDataElementOptions(c, e.active ? "active" : s),
        ...
        class L extends y {
                        ...
                        labels: {
                            generateLabels(t) {
                                ...
                                if (e.labels.length && e.datasets.length) {
                                    let { labels: { pointStyle: i, color: s } } = t.legend.options;
            ...
            _getRotation() {
                return (0,
                    s.t)(this.options.rotation - 90)
            }
            _getCircumference() {
                return (0,
                    s.t)(this.options.circumference)
            }
            _getRotationExtents() {
                let t = s.T
                    , e = -s.T;
            ...
            update(t) {
                let { chartArea: e } = this.chart
                    ...
                    , o = Math.min((0,
                        s.m)(this.options.cutout, r), 1)
                    , l = this._getRingWeight(this.index)
                    , { circumference: h, rotation: d } = this._getRotationExtents()
                    , { ratioX: c, ratioY: u, offsetX: g, offsetY: p } = function (t, e, i) {
                        let a = 1
                            , n = 1
                            , r = 0
                            , o = 0;
                        if (e < s.T) {
                            let l = t + e
                                ...
                                , u = Math.sin(l)
                                , g = (e, a, n) => (0,
                                    s.p)(e, t, l, !0) ? 1 : Math.max(a, a * i, n, n * i)
                                , p = (e, a, n) => (0,
                                    s.p)(e, t, l, !0) ? -1 : Math.min(a, a * i, n, n * i)
                                , f = g(0, h, c)
                                , m = g(s.H, d, u)
                                , x = p(s.P, h, c)
                                , b = p(s.P + s.H, d, u);
                    ...
                    , m = (e.height - n) / u
                    , x = (0,
                        s.n)(this.options.radius, Math.max(Math.min(f, m) / 2, 0))
                    , b = Math.max(x * o, 0)
                    , _ = (x - b) / this._getVisibleDatasetWeightTotal();
                this.offsetX = g * x,
                    this.offsetY = p * x,
            ...
            updateElements(t, e, i, s) {
                ...
                for (a = e; a < e + i; ++a) {
                    ...
                    f && (r.options = p || this.resolveDataElementOptions(a, i.active ? "active" : s)),
                        m += e,
            ...
            getLabelAndValue(t) {
                let e = this._cachedMeta
                    ...
                    , a = i.data.labels || []
                    , n = (0,
                        s.o)(e._parsed[t], i.options.locale);
                return {
                    label: a[t] || "",
                    value: n
                }
            ...
            getMaxBorderWidth(t) {
                let e, i, s, a, n, r = 0, o = this.chart;
                if (!t) {
                    for (e = 0,
                        i = o.data.datasets.length; e < i; ++e)
                        if (o.isDatasetVisible(e)) {
                            t = (s = o.getDatasetMeta(e)).data,
                                a = s.controller;
                            break
                        }
                }
                ...
                for (e = 0,
                    i = t.length; e < i; ++e)
                    "inner" !== (n = a.resolveDataElementOptions(e)).borderAlign && (r = Math.max(r, n.borderWidth || 0, n.hoverBorderWidth || 0));
                return r
            }
            getMaxOffset(t) {
                let e = 0;
            ...
            _getRingWeight(t) {
                return Math.max((0,
                    s.v)(this.chart.data.datasets[t].weight, 1), 0)
            }
        ...
        class E extends y {
            ...
            updateElements(t, e, i, a) {
                let n = "reset" === a
                    , { iScale: r, vScale: o, _stacked: l, _dataset: h } = this._cachedMeta
                    , { sharedOptions: d, includeOptions: c } = this._getSharedOptions(e, a)
                    , u = r.axis
                    , g = o.axis
                    , { spanGaps: p, segment: f } = this.options
                    , m = (0,
                        s.x)(p) ? p : Number.POSITIVE_INFINITY
                ...
                for (let i = 0; i < _; ++i) {
                    ...
                    _.skip = isNaN(w) || isNaN(k) || M,
                        ...
                        f && (_.parsed = y,
                            _.raw = h.data[i]),
                        c && (_.options = d || this.resolveDataElementOptions(i, p.active ? "active" : a)),
        ...
        class O extends y {
            ...
            getLabelAndValue(t) {
                let e = this._cachedMeta
                    ...
                    , a = i.data.labels || []
                    , n = (0,
                        s.o)(e._parsed[t].r, i.options.locale);
                return {
                    label: a[t] || "",
                    value: n
                }
            ...
            updateElements(t, e, i, a) {
                ...
                for (n = e; n < e + i; n++) {
                    ...
                    g = s,
                        r && (l.animateScale && (f = 0),
                            l.animateRotate && (i = s = u));
                    let m = {
                        x: d,
                        y: c,
                        innerRadius: 0,
            ...
            _computeAngle(t, e, i) {
                return this.chart.getDataVisibility(t) ? (0,
                    s.t)(this.resolveDataElementOptions(t, e).angle || i) : 0
            }
        }
        class T extends L {
            static id = "pie";
        ...
        class F extends y {
            ...
            updateElements(t, e, i, a) {
                let n = "reset" === a
                    ...
                    , x = (0,
                        s.x)(f) ? f : Number.POSITIVE_INFINITY
                ...
                for (let d = e; d < e + i; ++d) {
                    ...
                    f.skip = isNaN(y) || isNaN(M) || v,
                        ...
                        m && (f.parsed = i,
                            f.raw = h.data[d]),
                        u && (f.options = c || this.resolveDataElementOptions(d, e.active ? "active" : a)),
        ...
        function N(t, e, i, a, n) {
            let r = [];
            return (n || t.isPointInArea(e)) && B(t, i, e, function (i, o, l) {
                (n || (0,
                    s.C)(i, t.chartArea, 0)) && i.inRange(e.x, e.y, a) && r.push({
                        element: i,
                        datasetIndex: o,
                        index: l
                    })
        ...
        function H(t, e, i, a, n, r) {
            ...
            return r || t.isPointInArea(e) ? "r" !== i || a ? function (t, e, i, s, a, n) {
                ...
                return B(t, i, e, function (i, h, d) {
                    let c = i.inRange(e.x, e.y, a);
                    if (s && !c)
                        return;
                    let u = i.getCenterPoint(a);
                    if (!(n || t.isPointInArea(u)) && !c)
                        return;
                    let g = o(e, u);
                    g < l ? (r = [{
                        element: i,
                ...
                B(t, i, e, function (t, i, a) {
                    let { startAngle: r, endAngle: l } = t.getProps(["startAngle", "endAngle"], n)
                        , { angle: h } = (0,
                            s.D)(t, {
                                x: e.x,
                                y: e.y
        ...
        function j(t, e, i, s, a) {
            let n = []
                , r = "x" === i ? "inXRange" : "inYRange"
                , o = !1;
            return (B(t, i, e, (t, s, l) => {
                t[r](e[i], a) && (n.push({
                    element: t,
                    datasetIndex: s,
                    index: l
            ...
            modes: {
                index(t, e, i, a) {
                    let n = (0,
                        ...
                        , l = i.intersect ? N(t, n, r, a, o) : H(t, n, r, !1, a, o)
                        , h = [];
                ...
                point(t, e, i, a) {
                    let n = (0,
                        s.z)(e, t);
                    return N(t, n, i.axis || "xy", a, i.includeInvisible || !1)
                },
                nearest(t, e, i, a) {
                    let n = (0,
                        s.z)(e, t)
                        , r = i.axis || "xy"
                        , o = i.includeInvisible || !1;
                    return H(t, n, r, i.intersect, a, o)
                },
                x(t, e, i, a) {
                    let n = (0,
                        s.z)(e, t);
                    return j(t, n, "x", i.intersect, a)
                },
                y(t, e, i, a) {
                    let n = (0,
                        s.z)(e, t);
                    return j(t, n, "y", i.intersect, a)
                }
            }
        };
        ...
        function Y(t, e) {
            return t.filter(t => -1 === $.indexOf(t.pos) && t.box.axis === e)
        }
        function Q(t, e) {
            return t.sort((t, i) => {
                let s = e ? i : t
        ...
        function G(t, e, i, a) {
            ...
            for (n = 0,
                ...
                let { same: r, other: u } = function (t, e, i, a) {
                    ...
                    let l = Math.max(0, e.outerWidth - X(o, t, "left", "right"))
                        , h = Math.max(0, e.outerHeight - X(o, t, "top", "bottom"))
                        , d = l !== t.w
                        , c = h !== t.h;
                    return t.w = l,
                        t.h = h,
            ...
            for (let l of t) {
                ...
                if (l.horizontal) {
                    let a = e.w * d
                        , r = h.size || t.height;
                    (0,
                        s.h)(h.start) && (o = h.start),
                        t.fullSize ? K(t, n.left, o, i.outerWidth - n.right - n.left, r) : K(t, e.left + h.placed, o, a, r),
                        h.start = o,
                        h.placed += a,
                        o = t.bottom
                } else {
                    let a = e.h * d
                        , o = h.size || t.width;
                    (0,
                        s.h)(h.start) && (r = h.start),
                        t.fullSize ? K(t, r, n.top, o, i.outerHeight - n.bottom - n.top) : K(t, r, e.top + h.placed, o, a),
                        h.start = r,
                        h.placed += a,
                        r = t.right
                }
        ...
        var Z = {
            ...
            update(t, e, i, a) {
                    ...
                    , l = function (t) {
                        let e = function (t) {
                            ...
                            for (e = 0,
                                i = (t || []).length; e < i; ++e)
                                s = t[e],
                                    ({ position: a, options: { stack: n, stackWeight: r = 1 } } = s),
                                    o.push({
                                        index: e,
                                        box: s,
                                        pos: a,
                            ...
                            , i = Q(e.filter(t => t.box.fullSize), !0)
                            , s = Q(U(e, "left"), !0)
                            , a = Q(U(e, "right"))
                            , n = Q(U(e, "top"), !0)
                            , r = Q(U(e, "bottom"))
                ...
                let g = Object.assign({
                    ...
                    , p = function (t, e) {
                        ...
                        for (i = 0,
                            ...
                            a.horizontal ? (a.width = h ? h * r : s && e.availableWidth,
                                a.height = o) : (a.width = r,
                ...
                G(l.fullSize, g, c, p),
                    ...
                    J(l.leftAndTop, g, c, p),
                    g.x += g.w,
                    g.y += g.h,
                    J(l.rightAndBottom, g, c, p),
                    t.chartArea = {
                        left: g.left,
                        top: g.top,
                        right: g.left + g.w,
        ...
        function to(t, e, i) {
            let s = t.canvas
                , a = new MutationObserver(t => {
                    let e = !1;
                    for (let i of t)
                        e = (e = e || tr(i.addedNodes, s)) && !tr(i.removedNodes, s);
                    e && i()
                }
                );
        ...
        function tl(t, e, i) {
            let s = t.canvas
                , a = new MutationObserver(t => {
                    let e = !1;
                    for (let i of t)
                        e = (e = e || tr(i.removedNodes, s)) && !tr(i.addedNodes, s);
                    e && i()
                }
                );
            return a.observe(document, {
        ...
        function tu(t, e, i) {
            ...
            return o.observe(n),
                th.size || window.addEventListener("resize", tc),
                th.set(t, r),
                o
        }
        function tg(t, e, i) {
            i && i.disconnect(),
                "resize" === e && (th.delete(t),
                    th.size || window.removeEventListener("resize", tc))
        }
        function tp(t, e, i) {
            let a = t.canvas
                , n = (0,
        ...
        class tf extends tt {
            ...
            releaseContext(t) {
                ...
                ["height", "width"].forEach(t => {
                    let a = i[t];
                    (0,
                        s.k)(a) ? e.removeAttribute(t) : e.setAttribute(t, a)
                }
                );
                let a = i.style || {};
            ...
            removeEventListener(t, e) {
                ...
                s && ((({
                    ...
                    t.canvas.removeEventListener(e, i, tn)
                }
                )(t, e, s),
                    i[e] = void 0)
            }
        ...
        function tx(t, e, i, a, n) {
            let r, o, l;
            let h = (0,
                s.v)(a, 0)
                , d = Math.min((0,
                    s.v)(n, t.length), t.length)
                , c = 0;
            for (i = Math.ceil(i),
                n && (i = (r = n - a) / Math.floor(r / i)),
                l = h; l < 0;)
                l = Math.round(h + ++c * i);
        ...
        let tb = t => "left" === t ? "right" : "right" === t ? "left" : t
            , t_ = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i
            , tv = (t, e) => Math.min(e || t, t);
        function ty(t, e) {
            let i = []
                , s = t.length / e
                , a = t.length
        ...
        function tw(t, e) {
            ...
            let i = (0,
                ...
                , a = (0,
                    s.E)(t.padding);
            return ((0,
                s.b)(t.text) ? t.text.length : 1) * i.lineHeight + a.height
        }
        class tk extends tm {
            constructor(t) {
                super(),
            ...
            getUserBounds() {
                ...
                return t = (0,
                    s.O)(t, Number.POSITIVE_INFINITY),
                    e = (0,
                        s.O)(e, Number.NEGATIVE_INFINITY),
                    i = (0,
                        s.O)(i, Number.POSITIVE_INFINITY),
                    a = (0,
                        s.O)(a, Number.NEGATIVE_INFINITY),
                {
                    min: (0,
                        s.O)(t, i),
                    max: (0,
            ...
            getMinMax(t) {
                let e, { min: i, max: a, minDefined: n, maxDefined: r } = this.getUserBounds();
                if (n && r)
                    return {
                        min: i,
                        max: a
            ...
            beforeUpdate() {
                (0,
                    s.Q)(this.options.beforeUpdate, [this])
            }
            update(t, e, i) {
                ...
                this._convertTicksToLabels(l ? ty(this.ticks, o) : this.ticks),
                    this.configure(),
                    this.beforeCalculateLabelRotation(),
                    this.calculateLabelRotation(),
                    this.afterCalculateLabelRotation(),
                    r.display && (r.autoSkip || "auto" === r.source) && (this.ticks = function (t, e) {
            ...
            afterUpdate() {
                (0,
                    s.Q)(this.options.afterUpdate, [this])
            }
            beforeSetDimensions() {
                (0,
                    s.Q)(this.options.beforeSetDimensions, [this])
            }
            setDimensions() {
            ...
            afterSetDimensions() {
                (0,
                    s.Q)(this.options.afterSetDimensions, [this])
            }
            _callHooks(t) {
                this.chart.notifyPlugins(t, this.getContext()),
                    (0,
                        s.Q)(this.options[t], [this])
            }
            beforeDataLimits() {
            ...
            beforeTickToLabelConversion() {
                (0,
                    s.Q)(this.options.beforeTickToLabelConversion, [this])
            }
            generateTickLabels(t) {
                ...
                for (e = 0,
                    i = t.length; e < i; e++)
                    (a = t[e]).label = (0,
                        s.Q)(n.callback, [a.value, e, t], this)
            }
            afterTickToLabelConversion() {
                (0,
                    s.Q)(this.options.afterTickToLabelConversion, [this])
            }
            beforeCalculateLabelRotation() {
                (0,
                    s.Q)(this.options.beforeCalculateLabelRotation, [this])
            }
            calculateLabelRotation() {
                let t, e, i;
                let a = this.options
                    , n = a.ticks
                    , r = tv(this.ticks.length, a.ticks.maxTicksLimit)
                    , o = n.minRotation || 0
                    , l = n.maxRotation
                    , h = o;
                ...
                let d = this._getLabelSizes()
                    ...
                    , u = d.highest.height
                    , g = (0,
                        s.S)(this.chart.width - c, 0, this.maxWidth);
                c + 6 > (t = a.offset ? this.maxWidth / r : g / (r - 1)) && (t = g / (r - (a.offset ? .5 : 1)),
                    e = this.maxHeight - tM(a.grid) - n.padding - tw(a.title, this.chart.options.font),
                    i = Math.sqrt(c * c + u * u),
                    h = Math.max(o, Math.min(l, h = (0,
                        s.U)(Math.min(Math.asin((0,
                            s.S)((d.highest.height + 6) / t, -1, 1)), Math.asin((0,
                                s.S)(e / i, -1, 1)) - Math.asin((0,
                                    s.S)(u / i, -1, 1))))))),
                    this.labelRotation = h
            }
            afterCalculateLabelRotation() {
                (0,
                    s.Q)(this.options.afterCalculateLabelRotation, [this])
            }
            afterAutoSkip() { }
            beforeFit() {
                (0,
                    s.Q)(this.options.beforeFit, [this])
            }
            fit() {
                let t = {
                    width: 0,
                    ...
                    , o = this.isHorizontal();
                if (r) {
                    let r = tw(a, e.options.font);
                    if (o ? (t.width = this.maxWidth,
                        t.height = tM(n) + r) : (t.height = this.maxHeight,
                            t.width = tM(n) + r),
                        i.display && this.ticks.length) {
                        let { first: e, last: a, widest: n, highest: r } = this._getLabelSizes()
                            , l = 2 * i.padding
                            , h = (0,
                                s.t)(this.labelRotation)
                            , d = Math.cos(h)
                            , c = Math.sin(h);
                        if (o) {
            ...
            _calculatePadding(t, e, i, s) {
                let { ticks: { align: a, padding: n }, position: r } = this.options
                ...
                if (this.isHorizontal()) {
                    let r = this.getPixelForTick(0) - this.left
                        ...
                        , c = 0;
                    o ? l ? (d = s * t.width,
                        c = i * e.height) : (d = i * t.height,
                            c = s * e.width) : "start" === a ? c = e.width : "end" === a ? d = t.width : "inner" !== a && (d = t.width / 2,
                                c = e.width / 2),
                        this.paddingLeft = Math.max((d - r + n) * this.width / (this.width - r), 0),
                        this.paddingRight = Math.max((c - h + n) * this.width / (this.width - h), 0)
                } else {
                    let i = e.height / 2
                        , s = t.height / 2;
                    "start" === a ? (i = 0,
                        s = t.height) : "end" === a && (i = e.height,
                            s = 0),
                        this.paddingTop = i + n,
            ...
            afterFit() {
                (0,
                    s.Q)(this.options.afterFit, [this])
            }
            isHorizontal() {
                            ...
                            for (n = 0,
                                ...
                                p = o[n],
                                    (0,
                                        s.k)(p) || (0,
                                            s.b)(p) || (u = (0,
                                                s.V)(f, d.data, d.gc, u, p),
                                                g += c)
                    } else
                        u = (0,
                            s.V)(f, d.data, d.gc, u, o),
                            g = c;
                    x.push(u),
                        b.push(g),
                        v = Math.max(u, v),
            ...
            getPixelForDecimal(t) {
                ...
                return (0,
                    s.W)(this._alignToPixels ? (0,
                        s.X)(this.chart, e, 0) : e)
            }
            ...
            getContext(t) {
                ...
                if (t >= 0 && t < a.length) {
                    let i = a[t];
                    return i.$context || (i.$context = (e = this.getContext(),
                        (0,
                            s.j)(e, {
                                tick: i,
                                index: t,
            ...
            _computeGridLineItems(t) {
                ...
                for (i = 0; i < M; i += E) {
                    ...
                    void 0 !== (a = function (t, e, i) {
                        ...
                        if (!i || (s = 1 === a ? Math.max(l - r, o - l) : 0 === e ? (t.getPixelForTick(1) - l) / 2 : (l - t.getPixelForTick(n - 1)) / 2,
            ...
            _computeLabelItems(t) {
                ...
                for (e = 0,
                    ...
                    let p = (c = (0,
                        ...
                        , k = o;
                    if (x ? (n = l,
                        "inner" === o && (k = e === i - 1 ? this.options.reverse ? "left" : "right" : 0 === e ? this.options.reverse ? "right" : "left" : "center"),
                        u = "top" === f ? "near" === v || 0 !== D ? -c * d + d / 2 : "center" === v ? -L.highest.height / 2 - p * d + d : -L.highest.height + d / 2 : "near" === v || 0 !== D ? d / 2 : "center" === v ? L.highest.height / 2 - p * d : L.highest.height - c * d,
                        M && (u *= -1),
                        0 === D || g.showLabelBackdrop || (n += d / 2 * Math.sin(D))) : (r = l,
                            u = (1 - c) * d / 2),
                        g.showLabelBackdrop) {
                        let a = (0,
                            s.E)(g.backdropPadding)
                            , n = L.heights[e]
                            , r = L.widths[e]
                            , l = u - a.top
                            , h = 0 - a.left;
            ...
            _getYAxisLabelAlignment(t) {
                let e, i;
                let { position: s, ticks: { crossAlign: a, mirror: n, padding: r } } = this.options
                    , o = this._getLabelSizes()
                    , l = t + r
                    , h = o.widest.width;
                return "left" === s ? n ? (i = this.right + r,
                    "near" === a ? e = "left" : "center" === a ? (e = "center",
                        i += h / 2) : (e = "right",
                            i += h)) : (i = this.right - l,
                                "near" === a ? e = "right" : "center" === a ? (e = "center",
                                    i -= h / 2) : (e = "left",
                                        i = this.left)) : "right" === s ? n ? (i = this.left + r,
                                            "near" === a ? e = "right" : "center" === a ? (e = "center",
                                                i -= h / 2) : (e = "left",
                                                    i -= h)) : (i = this.left + l,
                                                        "near" === a ? e = "left" : "center" === a ? (e = "center",
                                                            i += h / 2) : (e = "right",
                                                                i = this.right)) : e = "right",
                {
                    textAlign: e,
                    x: i
                }
            ...
            drawBackground() {
                let { ctx: t, options: { backgroundColor: e }, left: i, top: s, width: a, height: n } = this;
                e && (t.save(),
                    t.fillStyle = e,
                    t.fillRect(i, s, a, n),
                    t.restore())
            ...
            drawBorder() {
                let t, e, i, a;
                let { chart: n, ctx: r, options: { border: o, grid: l } } = this
                ...
                let c = l.setContext(this.getContext(0)).lineWidth
                    , u = this._borderValue;
                this.isHorizontal() ? (t = (0,
                    s.X)(n, this.left, d) - d / 2,
                    e = (0,
                        s.X)(n, this.right, c) + c / 2,
                    i = a = u) : (i = (0,
                        s.X)(n, this.top, d) - d / 2,
                        a = (0,
                            s.X)(n, this.bottom, c) + c / 2,
                        t = e = u),
                    r.save(),
                    r.lineWidth = h.width,
            ...
            drawTitle() {
                let t;
                let { ctx: e, options: { position: i, title: a, reverse: n } } = this;
                if (!a.display)
                    return;
                let r = (0,
                    s.a0)(a.font)
                ...
                "bottom" === i || "center" === i || (0,
                    s.i)(i) ? (h += o.bottom,
                        (0,
                            s.b)(a.text) && (h += r.lineHeight * (a.text.length - 1))) : h += o.top;
                let { titleX: d, titleY: c, maxWidth: u, rotation: g } = function (t, e, i, a) {
                    let n, r, o;
                    ...
                    if (t.isHorizontal()) {
                        if (r = (0,
                            ...
                            o = "center" === i ? (g.bottom + g.top) / 2 + m - e : t_(t, i, e);
                        n = c - h
                    } else {
                        if ((0,
                            s.i)(i)) {
                            ...
                            r = "center" === i ? (g.left + g.right) / 2 - x + e : t_(t, i, e);
                        o = (0,
                            s.a2)(a, d, l),
                            f = "left" === i ? -s.H : s.H
                    }
            ...
            _layers() {
                let t = this.options
                    ...
                    , i = (0,
                        s.v)(t.grid && t.grid.z, -1)
                    , a = (0,
                        s.v)(t.border && t.border.z, 0);
                return this._isVisible() && this.draw === tk.prototype.draw ? [{
                    z: i,
                    draw: t => {
                        this.drawBackground(),
                            this.drawGrid(t),
        ...
        class tS {
            ...
            register(t) {
                ...
                let a = this.items
                    ...
                    , r = this.scope + "." + n;
                if (!n)
                    throw Error("class does not have id: " + t);
                return n in a || (a[n] = t,
                    function (t, e, i) {
                        let a = (0,
                            s.a4)(Object.create(null), [i ? s.d.get(i) : {}, s.d.get(e), t.defaults]);
                        s.d.set(e, a),
            ...
            unregister(t) {
                let e = this.items
                    ...
                    , a = this.scope;
                i in e && delete e[i],
                    a && i in s.d[a] && (delete s.d[a][i],
                        this.override && delete s.a3[i])
            }
        }
        class tD {
            constructor() {
                this.controllers = new tS(y, "datasets", !0),
                    this.elements = new tS(tm, "elements"),
                    this.plugins = new tS(Object, "plugins"),
                    this.scales = new tS(tk, "scales"),
            ...
            _each(t, e, i) {
                [...e].forEach(e => {
                    ...
                    i || a.isForType(e) || a === this.plugins && e.id ? this._exec(t, a, e) : (0,
                        s.F)(e, e => {
        ...
        class tC {
            ...
            notify(t, e, i, s) {
                ...
                return "afterDestroy" === e && (this._notify(a, t, "stop"),
            ...
            invalidate() {
                (0,
                    s.k)(this._cache) || (this._oldCache = this._cache,
                        this._cache = void 0)
            }
            _descriptors(t) {
                if (this._cache)
            ...
            _createDescriptors(t, e) {
                let i = t && t.config
                    ...
                    , n = function (t) {
                        let e = {}
                            , i = []
                            , s = Object.keys(tP.plugins.items);
                        for (let t = 0; t < s.length; t++)
                            i.push(tP.getPlugin(s[t]));
                        let a = t.plugins || [];
                        for (let t = 0; t < a.length; t++) {
                            let s = a[t];
                ...
                return !1 !== a || e ? function (t, { plugins: e, localIds: i }, s, a) {
                    let n = []
                        , r = t.getContext();
                    for (let l of e) {
                        var o;
                        ...
                        null !== h && n.push({
                            ...
                            options: function (t, { plugin: e, local: i }, s, a) {
                                ...
                                return i && e.defaults && r.push(e.defaults),
        ...
        function tO(t, ...e) {
            ...
            for (let s of e) {
                var i;
                let e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && tE(t[0].toLowerCase());
                if (e)
                    return e
            }
                ...
                e.scales = function (t, e) {
                    ...
                    return Object.keys(a).forEach(e => {
                        ...
                        t.data.datasets.forEach(i => {
                            let n = i.type || t.type
                                , o = i.indexAxis || tL(n, e)
                                , l = (s.a3[n] || {}).scales || {};
                            Object.keys(l).forEach(t => {
                                let e;
                                let n = (e = t,
                                    "_index_" === t ? e = o : "_value_" === t && (e = "x" === o ? "y" : "x"),
                                    e)
                                    , h = i[n + "AxisID"] || n;
                        ...
                        Object.keys(r).forEach(t => {
                            let e = r[t];
                            (0,
                                s.ab)(e, [s.d.scales[e.type], s.d.scale])
                        }
                        ),
                        r
                }(t, e)
        ...
        class tB {
            constructor(t) {
                var e;
                this._config = ((e = (e = t) || {}).data = tF(e.data),
                    tA(e),
                    e),
            ...
            datasetAnimationScopeKeys(t, e) {
                return tI(`${t}.transition.${e}`, () => [[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]])
            }
            datasetElementScopeKeys(t, e) {
                return tI(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]])
            }
            pluginScopeKeys(t) {
                let e = t.id
                    , i = this.type;
                return tI(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...t.additionalOptionScopes || []]])
            }
            _cachedScopes(t, e) {
            ...
            getOptionScopes(t, e, i) {
                ...
                e.forEach(e => {
                    t && (l.add(t),
                        e.forEach(e => tV(l, t, e))),
                        e.forEach(t => tV(l, a, t)),
                        e.forEach(t => tV(l, s.a3[n] || {}, t)),
                        e.forEach(t => tV(l, s.d, t)),
                        e.forEach(t => tV(l, s.a6, t))
                }
                );
                let h = Array.from(l);
            ...
            resolveNamedOptions(t, e, i, a = [""]) {
                let n = {
                    ...
                    , { resolver: r, subPrefixes: o } = tN(this._resolverCache, t, a)
                    , l = r;
                if (function (t, e) {
                    let { isScriptable: i, isIndexable: a } = (0,
                        s.aa)(t);
                    for (let n of e) {
                        let e = i(n)
                            , r = a(n)
            ...
            createResolver(t, e, i = [""], a) {
                let { resolver: n } = tN(this._resolverCache, t, i);
                return (0,
                    s.i)(e) ? (0,
                        s.a8)(n, e, void 0, a) : n
            }
        ...
        let tH = t => (0,
            s.i)(t) && Object.getOwnPropertyNames(t).some(e => (0,
                s.a7)(t[e]))
            , tj = ["top", "bottom", "left", "right", "chartArea"];
        function tW(t, e) {
            return "top" === t || "bottom" === t || -1 === tj.indexOf(t) && "x" === e
        }
        function t$(t, e) {
            return function (i, s) {
        ...
        function tU(t) {
            ...
            e.notifyPlugins("afterRender"),
                (0,
                    s.Q)(i && i.onComplete, [t], e)
        }
        function tY(t) {
            let e = t.chart
                , i = e.options.animation;
            (0,
                s.Q)(i && i.onProgress, [t], e)
        }
        function tQ(t) {
            return (0,
                s.M)() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        let tX = {}
            , tq = t => {
                let e = tQ(t);
                return Object.values(tX).filter(t => t.canvas === e).pop()
            }
            ;
        function tG(t, e, i) {
        ...
        class tK {
            ...
            constructor(t, e) {
                let i = this.config = new tB(e)
                    , a = tQ(t)
                    , r = tq(a);
                if (r)
                    throw Error("Canvas is already in use. Chart with ID '" + r.id + "' must be destroyed before the canvas with ID '" + r.canvas.id + "' can be reused.");
                let o = i.createResolver(i.chartOptionScopes(), this.getContext());
                this.platform = new (i.platform || (!(0,
                    s.M)() || "undefined" != typeof OffscreenCanvas && a instanceof OffscreenCanvas ? te : tf)),
                ...
                if (this.id = (0,
                    ...
                    this.$context = void 0,
                    this._doResize = (0,
                        s.ad)(t => this.update(t), o.resizeDelay || 0),
                    this._dataChanges = [],
                    tX[this.id] = this,
                    !l || !h) {
                ...
                n.listen(this, "complete", tU),
                    n.listen(this, "progress", tY),
                    this._initialize(),
                    this.attached && this.update()
            }
            get aspectRatio() {
                let { options: { aspectRatio: t, maintainAspectRatio: e }, width: i, height: a, _aspectRatio: n } = this;
                return (0,
                    s.k)(t) ? e && n ? n : a ? i / a : null : t
            }
            get data() {
            ...
            _initialize() {
                return this.notifyPlugins("beforeInit"),
                    this.options.responsive ? this.resize() : (0,
                        s.ae)(this, this.options.devicePixelRatio),
                    this.bindEvents(),
            ...
            _resize(t, e) {
                ...
                this.width = r.width,
                    ...
                    this._aspectRatio = this.aspectRatio,
                    (0,
                        s.ae)(this, o, !0) && (this.notifyPlugins("resize", {
                            size: r
                        }),
                            (0,
                                s.Q)(i.onResize, [this, r], this),
                    ...
                    (0,
                        s.F)(n, e => {
                            let n = e.options
                                ...
                                , l = (0,
                                    s.v)(n.type, e.dtype);
                            (void 0 === n.position || tW(n.position, o) !== tW(e.dposition)) && (n.position = e.dposition),
                                a[r] = !0;
                            let h = null;
                            r in i && i[r].type === l ? h = i[r] : i[(h = new (tP.getScale(l))({
                                id: r,
                                type: l,
                                ctx: this.ctx,
                                chart: this
            ...
            _updateMetasets() {
                ...
                this._sortedMetasets = t.slice(0).sort(t$("order", "index"))
            }
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(),
                    ...
                    if (n.type && n.type !== r && (this._destroyDatasetMeta(t),
                        n = this.getDatasetMeta(t)),
                        n.type = r,
                        n.indexAxis = e.indexAxis || tL(r, this.options),
                        n.order = e.order || 0,
                        n.index = t,
                        n.label = "" + e.label,
                        n.visible = this.isDatasetVisible(t),
                        n.controller)
                        n.controller.updateIndex(t),
                            n.controller.linkScales();
                    else {
                        let e = tP.getController(r)
                            , { datasetElementType: a, dataElementType: o } = s.d.datasets[r];
                        Object.assign(e, {
                            dataElementType: tP.getElement(o),
                            datasetElementType: a && tP.getElement(a)
                        }),
            ...
            update(t) {
                ...
                r = this._minPadding = i.layout.autoPadding ? r : 0,
                    ...
                    this._layers.sort(t$("z", "_idx"));
                let { _active: o, _lastEvent: l } = this;
                l ? this._eventHandler(l, !0) : o.length && this._updateHoverStyles(o, o, !0),
                    this.render()
            }
            _updateScales() {
                (0,
            ...
            _checkEventBindings() {
                let t = this.options
                    ...
                    , i = new Set(t.events);
                (0,
                    s.ag)(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
                        this.bindEvents())
            }
            _updateHiddenIndices() {
                let { _hiddenIndices: t } = this;
                for (let { method: e, start: i, count: s } of this._getUniformDataChanges() || [])
                    !function (t, e, i) {
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {
                    cancelable: !0
                }) && (n.has(this) ? this.attached && !n.running(this) && n.start(this) : (this.draw(),
                    tU({
                        chart: this
                    })))
            }
            ...
            _drawDataset(t) {
                ...
                !1 !== this.notifyPlugins("beforeDatasetDraw", r) && (a && (0,
                    s.Y)(e, {
            ...
            bindUserEvents() {
                let t = this._listeners
                    ...
                    ;
                (0,
                    s.F)(this.options.events, t => i(t, a))
            }
            bindResponsiveEvents() {
                ...
                let e = this._responsiveListeners
                    , i = this.platform
                    , s = (t, s) => {
                        i.addEventListener(this, t, s),
                            e[t] = s
                    }
                    , a = (t, s) => {
                        e[t] && (i.removeEventListener(this, t, s),
                            delete e[t])
                    }
                    , n = (t, e) => {
            ...
            unbindEvents() {
                (0,
                    s.F)(this._listeners, (t, e) => {
                        this.platform.removeEventListener(this, e, t)
                    }
                    ),
                    this._listeners = {},
                    (0,
                        s.F)(this._responsiveListeners, (t, e) => {
                            this.platform.removeEventListener(this, e, t)
                        }
                        ),
                    this._responsiveListeners = void 0
            ...
            updateHoverStyle(t, e, i) {
                let s, a, n;
                let r = i ? "set" : "remove";
                for ("dataset" === e && this.getDatasetMeta(t[0].datasetIndex).controller["_" + r + "DatasetHoverStyle"](),
                    a = 0,
                    n = t.length; a < n; ++a) {
            ...
            setActiveElements(t) {
                let e = this._active || []
                    , i = t.map(({ datasetIndex: t, index: e }) => {
                        let i = this.getDatasetMeta(t);
                        if (!i)
                            throw Error("No dataset found at index " + t);
                        return {
                            datasetIndex: t,
                            element: i.data[e],
                            index: e
            ...
            _handleEvent(t, e, i) {
                ...
                i && (this._lastEvent = null,
                    (0,
                        s.Q)(r.onHover, [t, o, this], this),
                    l && (0,
                        s.Q)(r.onClick, [t, o, this], this));
                let d = !(0,
                    s.ah)(o, n);
                return (d || e) && (this._active = o,
                    this._updateHoverStyles(o, n, e)),
                    this._lastEvent = h,
                    d
            }
        ...
        function tJ() {
            return (0,
                s.F)(tK.instances, t => t._plugins.invalidate())
        }
        function tZ(t, e, i, s) {
            return {
                x: i + t * Math.cos(e),
        ...
        function t0(t, e, i, a, n, r) {
            ...
            let m = Math.max(.001, f * u - i / s.P) / u
                ...
                , b = h + x + p
                , _ = n - x - p
                , { outerStart: v, outerEnd: y, innerStart: M, innerEnd: w } = function (t, e, i, a) {
                    var n;
                    let r = (n = t.options.borderRadius,
                        (0,
                            s.ak)(n, ["outerStart", "outerEnd", "innerStart", "innerEnd"]))
                        , o = (i - e) / 2
                        , l = Math.min(o, a * e / 2)
                        , h = t => {
                            let e = (i - Math.min(o, t)) * a / 2;
                            return (0,
                                s.S)(t, 0, Math.min(o, e))
                        }
                        ;
                    return {
        ...
        class t1 extends tm {
            ...
            inRange(t, e, i) {
                let a = this.getProps(["x", "y"], i)
                    , { angle: n, distance: r } = (0,
                        s.D)(a, {
                            x: t,
                            y: e
                        })
                    , { startAngle: o, endAngle: l, innerRadius: h, outerRadius: d, circumference: c } = this.getProps(["startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], i)
            ...
            getCenterPoint(t) {
                let { x: e, y: i, startAngle: s, endAngle: a, innerRadius: n, outerRadius: r } = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"], t)
            ...
            draw(t) {
                ...
                t.fillStyle = e.backgroundColor,
                    ...
                    function (t, e, i, a, n) {
                        let { fullCircles: r, startAngle: o, circumference: l, options: h } = e
                            , { borderWidth: d, borderJoinStyle: c, borderDash: u, borderDashOffset: g } = h
                        ...
                        t.setLineDash(u || []),
                            t.lineDashOffset = g,
                            p ? (t.lineWidth = 2 * d,
                                t.lineJoin = c || "round") : (t.lineWidth = d,
                                    t.lineJoin = c || "bevel");
                        let f = e.endAngle;
                        if (r) {
                            t0(t, e, i, a, f, n);
                        ...
                        p && function (t, e, i) {
                            let { startAngle: a, pixelMargin: n, x: r, y: o, outerRadius: l, innerRadius: h } = e
                                , d = n / l;
                            t.beginPath(),
                                t.arc(r, o, l, a - d, i + d),
                                h > n ? (d = n / h,
                                    t.arc(r, o, h, i + d, a - d, !0)) : t.arc(r, o, n, i + s.H, a - s.H),
                                t.closePath(),
                                t.clip()
                        }(t, e, f),
                            r || (t0(t, e, i, a, f, n),
        ...
        function t2(t, e, i = e) {
            t.lineCap = (0,
                s.v)(i.borderCapStyle, e.borderCapStyle),
                t.setLineDash((0,
                    s.v)(i.borderDash, e.borderDash)),
                t.lineDashOffset = (0,
                    s.v)(i.borderDashOffset, e.borderDashOffset),
                t.lineJoin = (0,
                    s.v)(i.borderJoinStyle, e.borderJoinStyle),
                t.lineWidth = (0,
                    s.v)(i.borderWidth, e.borderWidth),
                t.strokeStyle = (0,
                    s.v)(i.borderColor, e.borderColor)
        }
        function t5(t, e, i) {
            t.lineTo(i.x, i.y)
        }
        ...
        function t6(t, e, i, a) {
            ...
            let { points: l, options: h } = e
                , { count: d, start: c, loop: u, ilen: g } = t3(l, i, a)
                , p = h.stepped ? s.ar : h.tension || "monotone" === h.cubicInterpolationMode ? s.as : t5
                , { move: f = !0, reverse: m } = a || {};
            for (n = 0; n <= g; ++n)
                (r = l[(c + (m ? g - n : n)) % d]).skip || (f ? (t.moveTo(r.x, r.y),
                    f = !1) : p(t, o, r, m, h.stepped),
                    o = r);
            return u && p(t, o, r = l[(c + (m ? g : 0)) % d], m, h.stepped),
                !!u
        }
        function t4(t, e, i, s) {
            let a, n, r, o, l, h;
            let d = e.points
                , { count: c, start: u, ilen: g } = t3(d, i, s)
        ...
        function t7(t) {
            ...
            return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? t6 : t4
        }
        let t8 = "function" == typeof Path2D;
        class t9 extends tm {
            static id = "line";
            static defaults = {
                borderCapStyle: "butt",
            ...
            get segments() {
                return this._segments || (this._segments = (0,
                    s.am)(this, this.options.segment))
            }
            first() {
                let t = this.segments
                    , e = this.points;
            ...
            draw(t, e, i, s) {
                ...
                (this.points || []).length && a.borderWidth && (t.save(),
                    function (t, e, i, s) {
                        if (t8 && !e.options.segment) {
                            let a;
                            (a = e._path) || (a = e._path = new Path2D,
        ...
        class ee extends tm {
            ...
            inXRange(t, e) {
                return et(this, t, "x", e)
            }
            inYRange(t, e) {
                return et(this, t, "y", e)
            }
            getCenterPoint(t) {
                let { x: e, y: i } = this.getProps(["x", "y"], t);
                return {
            ...
            draw(t, e) {
                let i = this.options;
                !this.skip && !(i.radius < .1) && (0,
                    s.C)(this, e, this.size(i) / 2) && (t.strokeStyle = i.borderColor,
                        t.lineWidth = i.borderWidth,
                        t.fillStyle = i.backgroundColor,
                        (0,
                            s.at)(t, i, this.x, this.y))
            }
            getRange() {
                let t = this.options || {};
        ...
        function ei(t, e) {
            let i, s, a, n, r;
            let { x: o, y: l, base: h, width: d, height: c } = t.getProps(["x", "y", "base", "width", "height"], e);
            return t.horizontal ? (r = c / 2,
                i = Math.min(o, h),
                s = Math.max(o, h),
                a = l - r,
                n = l + r) : (i = o - (r = d / 2),
        ...
        function ea(t, e, i, a) {
            let n = null === e
                ...
                , o = t && !(n && r) && ei(t, a);
            return o && (n || (0,
                s.aj)(e, o.left, o.right)) && (r || (0,
                    s.aj)(i, o.top, o.bottom))
        }
        function en(t, e) {
        ...
        class eo extends tm {
            ...
            draw(t) {
                var e;
                let { inflateAmount: i, options: { borderColor: a, backgroundColor: n } } = this
                            ...
                            , n = function (t, e, i) {
                                let a = t.options.borderWidth
                                    ...
                                    , r = (0,
                                        s.av)(a);
                                return {
                                    t: es(n.top, r.top, 0, i),
                                    r: es(n.right, r.right, 0, e),
                                    b: es(n.bottom, r.bottom, 0, i),
                                    l: es(n.left, r.left, 0, e)
                                }
                            }(t, i / 2, a / 2)
                            , r = function (t, e, i) {
                                let { enableBorderRadius: a } = t.getProps(["enableBorderRadius"])
                                    ...
                                    , h = a || (0,
                                        s.i)(n);
                                return {
                                    topLeft: es(!h || l.top || l.left, r.topLeft, 0, o),
                                    topRight: es(!h || l.top || l.right, r.topRight, 0, o),
                                    bottomLeft: es(!h || l.bottom || l.left, r.bottomLeft, 0, o),
                                    bottomRight: es(!h || l.bottom || l.right, r.bottomRight, 0, o)
                                }
                            }(t, i / 2, a / 2);
                        return {
                            outer: {
                    ...
                    , l = (e = o.radius).topLeft || e.topRight || e.bottomLeft || e.bottomRight ? s.au : en;
                t.save(),
                    (o.w !== r.w || o.h !== r.h) && (t.beginPath(),
                        l(t, er(o, i, r)),
                        t.clip(),
                        l(t, er(r, -i, o)),
                        t.fillStyle = a,
            ...
            inRange(t, e, i) {
                return ea(this, t, e, i)
            }
            inXRange(t, e) {
                return ea(this, t, null, e)
            }
            inYRange(t, e) {
                return ea(this, null, t, e)
            }
            getCenterPoint(t) {
                let { x: e, y: i, base: s, horizontal: a } = this.getProps(["x", "y", "base", "horizontal"], t);
                return {
                    x: a ? (e + s) / 2 : e,
                    y: a ? i : (i + s) / 2
                }
        ...
        let eh = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"]
            , ed = eh.map(t => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
        function ec(t) {
        ...
        function eM(t, e, i) {
            let a = function (t) {
                            ...
                            for (let t = e.start; t <= e.end; t++)
                                !function (t, e, i) {
                                    ...
                                    for (let n = 0; n < i.length; n++) {
                                        let { first: r, last: o, point: l } = function (t, e, i) {
                ...
                if ("shape" === i)
                    return !0;
                let n = (t.scale || {}).getPointPositionForValue ? function (t) {
                    let { scale: e, fill: i } = t
                        , a = e.options
                        , n = e.getLabels().length
                        , r = a.reverse ? e.max : e.min
                        , o = "start" === i ? r : "end" === i ? e.options.reverse ? e.min : e.max : (0,
                            s.i)(i) ? i.value : e.getBaseValue()
                        , l = [];
                    if (a.grid.circular) {
                    ...
                    let { scale: i = {}, fill: a } = t
                        , n = (e = null,
                            "start" === a ? e = i.bottom : "end" === a ? e = i.top : (0,
                                s.i)(a) ? e = i.getPixelForValue(a.value) : i.getBasePixel && (e = i.getBasePixel()),
                            e);
                    if ((0,
                        s.g)(n)) {
                ...
                return n instanceof ey ? n : e_(n, a)
            }(e)
        ...
        function ek(t, e) {
            ...
            for (let { source: e, target: l, start: h, end: d } of function (t, e, i) {
                let a = t.segments
                    , n = t.points
                    , r = e.points
                    , o = [];
                for (let t of a) {
                    ...
                    for (let a of (0,
                        s.an)(e, h)) {
                        let e = em(i, r[a.start], r[a.end], a.loop);
                        for (let r of (0,
                            s.ax)(t, n, e))
                            o.push({
                                source: r,
                                target: a,
                                start: {
                                    [i]: eb(h, e, "start", Math.max)
                                },
                                end: {
                                    [i]: eb(h, e, "end", Math.min)
                                }
                            })
                    }
                }
                ...
                if (u) {
                    g ? t.closePath() : eS(t, a, d, n);
                    let e = !!a.pathSegment(t, l, {
                        move: g,
                        reverse: !0
                    });
                    (s = g && e) || eS(t, a, h, n)
        ...
        let eD = (t, e) => {
            ...
            , eP = (t, e) => null !== t && null !== e && t.datasetIndex === e.datasetIndex && t.index === e.index;
        class eC extends tm {
            constructor(t) {
                super(),
                    this._added = !1,
            ...
            buildLabels() {
                let t = this.options.labels || {}
                    , e = (0,
                        s.Q)(t.generateLabels, [this.chart], this) || [];
            ...
            fit() {
                ...
                let n = i.labels
                    ...
                    , { boxWidth: h, itemHeight: d } = eD(n, o);
                a.font = r.string,
                    this.isHorizontal() ? (t = this.maxWidth,
                        e = this._fitRows(l, o, h, d) + 10) : (e = this.maxHeight,
                            t = this._fitCols(l, r, h, d) + 10),
                    this.width = Math.min(t, i.maxWidth || this.maxWidth),
                    this.height = Math.min(e, i.maxHeight || this.maxHeight)
            }
            _fitRows(t, e, i, s) {
                let { ctx: a, maxWidth: n, options: { labels: { padding: r } } } = this
                ...
                return this.legendItems.forEach((t, g) => {
                    ...
                    (0 === g || l[l.length - 1] + p + 2 * r > n) && (d += h,
                        l[l.length - (g > 0 ? 0 : 1)] = 0,
                        u += h,
                        c++),
                        o[g] = {
                            left: 0,
            ...
            _fitCols(t, e, i, s) {
                let { ctx: a, maxHeight: n, options: { labels: { padding: r } } } = this
                    , o = this.legendHitBoxes = []
                    , l = this.columnSizes = []
                    , h = n - t
                    , d = r
                ...
                return this.legendItems.forEach((t, n) => {
                    var f;
                    let m, x;
                    let { itemWidth: b, itemHeight: _ } = {
                        itemWidth: ((m = t.text) && "string" != typeof m && (m = m.reduce((t, e) => t.length > e.length ? t : e)),
                            i + e.size / 2 + a.measureText(m).width),
                        itemHeight: (f = e.lineHeight,
                            x = s,
                            "string" != typeof t.text && (x = eL(t, f)),
                            x)
                    };
                    n > 0 && u + _ + 2 * r > h && (d += c + r,
                        l.push({
            ...
            adjustHitBoxes() {
                ...
                let t = this._computeTitleHeight()
                    , { legendHitBoxes: e, options: { align: i, labels: { padding: a }, rtl: n } } = this
                    , r = (0,
                        s.az)(n, this.left, this.width);
                if (this.isHorizontal()) {
                    let n = 0
                        , o = (0,
                            s.a2)(i, this.left + a, this.right - this.lineWidths[n]);
                    for (let l of e)
                        n !== l.row && (n = l.row,
                            o = (0,
                                s.a2)(i, this.left + a, this.right - this.lineWidths[n])),
                    ...
                    let n = 0
                        , o = (0,
                            s.a2)(i, this.top + t + a, this.bottom - this.columnSizes[n].height);
                    for (let l of e)
                        l.col !== n && (n = l.col,
                            o = (0,
                                s.a2)(i, this.top + t + a, this.bottom - this.columnSizes[n].height)),
            ...
            _draw() {
                ...
                let { options: e, columnSizes: i, lineWidths: a, ctx: n } = this
                    ...
                    , l = s.d.color
                    , h = (0,
                        s.az)(e.rtl, this.left, this.width)
                    , d = (0,
                        s.a0)(o.font)
                    , { padding: c } = o
                    , u = d.size
                ...
                this.drawTitle(),
                    ...
                    n.lineWidth = .5,
                    n.font = d.string;
                let { boxWidth: p, boxHeight: f, itemHeight: m } = eD(o, u)
                    , x = function (t, e, i) {
                        ...
                        if (n.fillStyle = (0,
                            ...
                            n.lineCap = (0,
                                s.v)(i.lineCap, "butt"),
                            n.lineDashOffset = (0,
                                s.v)(i.lineDashOffset, 0),
                            n.lineJoin = (0,
                                s.v)(i.lineJoin, "miter"),
                            n.lineWidth = a,
                            n.strokeStyle = (0,
                                s.v)(i.strokeStyle, l),
                            n.setLineDash((0,
                            ...
                            let r = {
                                ...
                                , l = h.xPlus(t, p / 2);
                            (0,
                                s.aD)(n, r, l, e + g, o.pointStyleWidth && p)
                        } else {
                ...
                t = _ ? {
                    x: (0,
                        s.a2)(r, this.left + c, this.right - a[0]),
                    y: this.top + c + v,
                    line: 0
                } : {
                    x: this.left + c,
                    y: (0,
                        s.a2)(r, this.top + v + c, this.bottom - i[0].height),
                    line: 0
                },
                    (0,
                        s.aA)(this.ctx, e.textDirection);
                let y = m + c;
                this.legendItems.forEach((l, u) => {
                    n.strokeStyle = l.fontColor,
                        n.fillStyle = l.fontColor;
                    let f = n.measureText(l.text).width
                        , m = h.textAlign(l.textAlign || (l.textAlign = o.textAlign))
                        , M = p + g + f
                        , w = t.x
                        , k = t.y;
                    if (h.setWidth(this.width),
                        _ ? u > 0 && w + M + c > this.right && (k = t.y += y,
                            t.line++,
                            w = t.x = (0,
                                s.a2)(r, this.left + c, this.right - a[t.line])) : u > 0 && k + y > this.bottom && (w = t.x = w + i[t.line].width + c,
                                    t.line++,
                                    k = t.y = (0,
                                        s.a2)(r, this.top + v + c, this.bottom - i[t.line].height)),
                        x(h.x(w), k, l),
                        w = (0,
                            s.aB)(m, w + p + g, _ ? w + M : this.right, e.rtl),
                        b(h.x(w), k, l),
                        _)
                        t.x += M + c;
            ...
            drawTitle() {
                ...
                if (this.isHorizontal())
                    u = Math.max(...this.lineWidths),
                        t = this.top + d,
                        c = (0,
                            s.a2)(e.align, c, this.right - u);
                else {
                    let i = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0);
                    t = d + (0,
                        s.a2)(e.align, this.top, this.bottom - i - e.labels.padding - this._computeTitleHeight())
                }
                let g = (0,
                    s.a2)(l, c, c + u);
                o.textAlign = r.textAlign((0,
                    s.a1)(l)),
            ...
            _getLegendItemAt(t, e) {
                let i, a, n;
                if ((0,
                    s.aj)(t, this.left, this.right) && (0,
                        s.aj)(e, this.top, this.bottom)) {
                    for (i = 0,
                        n = this.legendHitBoxes; i < n.length; ++i)
                        if (a = n[i],
                            (0,
                                s.aj)(t, a.left, a.left + a.width) && (0,
                                    s.aj)(e, a.top, a.top + a.height))
            ...
            handleEvent(t) {
                var e;
                let i = this.options;
                if (("mousemove" !== (e = t.type) && "mouseout" !== e || !i.onHover && !i.onLeave) && (!i.onClick || "click" !== e && "mouseup" !== e))
                    return;
                ...
                if ("mousemove" === t.type || "mouseout" === t.type) {
                    let e = this._hoveredItem
                        , n = eP(e, a);
                    e && !n && (0,
                        s.Q)(i.onLeave, [t, e, this], this),
                        this._hoveredItem = a,
                        a && !n && (0,
                            s.Q)(i.onHover, [t, a, this], this)
                } else
                    a && (0,
                        s.Q)(i.onClick, [t, a, this], this)
            }
        }
        function eL(t, e) {
        ...
        class eE extends tm {
            ...
            update(t, e) {
                ...
                let a = (0,
                    s.b)(i.text) ? i.text.length : 1;
                this._padding = (0,
                    s.E)(i.padding);
                let n = a * (0,
                    s.a0)(i.font).lineHeight + this._padding.height;
            ...
            _drawArgs(t) {
                ...
                let { top: n, left: r, bottom: o, right: l, options: h } = this
                    , d = h.align
                    , c = 0;
                return this.isHorizontal() ? (i = (0,
                    s.a2)(d, r, l),
                    a = n + t,
                    e = l - r) : ("left" === h.position ? (i = r + t,
                        a = (0,
                            s.a2)(d, o, n),
                        c = -.5 * s.P) : (i = l - t,
                            a = (0,
            ...
            draw() {
                ...
                let i = (0,
                    ...
                    , { titleX: n, titleY: r, maxWidth: o, rotation: l } = this._drawArgs(a);
                (0,
                    s.Z)(t, e.text, 0, 0, i, {
                        color: e.color,
                        maxWidth: o,
        ...
        function eA(t, e) {
            return e && ((0,
                s.b)(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                t
        }
        function eF(t) {
        ...
        function ez(t, e) {
            ...
            b += t.beforeBody.length + t.afterBody.length,
                u && (m += u * d.lineHeight + (u - 1) * e.titleSpacing + e.titleMarginBottom),
                b && (m += p * (e.displayColors ? Math.max(l, h.lineHeight) : h.lineHeight) + (b - p) * h.lineHeight + (b - 1) * e.bodySpacing),
            ...
            return i.save(),
                ...
                i.font = h.string,
                (0,
                    s.F)(t.beforeBody.concat(t.afterBody), v),
                ...
                xAlign: i.xAlign || e.xAlign || function (t, e, i, s) {
                    ...
                    return "center" === s ? h = a <= (o + l) / 2 ? "left" : "right" : a <= n / 2 ? h = "left" : a >= r - n / 2 && (h = "right"),
                        function (t, e, i, s) {
                            ...
                            if ("left" === t && a + n + r > e.width || "right" === t && a - n - r < 0)
                                return !0
                        }(h, t, e, i) && (h = "center"),
                        h
                }(t, e, i, s),
        ...
        function eI(t, e, i, a) {
            let { caretSize: n, caretPadding: r, cornerRadius: o } = t
                , { xAlign: l, yAlign: h } = i
                , d = n + r
                , { topLeft: c, topRight: u, bottomLeft: g, bottomRight: p } = (0,
                    s.aw)(o)
                , f = function (t, e) {
                    let { x: i, width: s } = t;
        ...
        function eH(t, e, i, s) {
            let a = t[e].call(i, s);
            return void 0 === a ? eN[e].call(i, s) : a
        }
        class ej extends tm {
            static positioners = eT;
            constructor(t) {
                super(),
                    this.opacity = 0,
                    this._active = [],
            ...
            _resolveAnimations() {
                ...
                return s._cacheable && (this._cachedAnimations = Object.freeze(a)),
                    a
            }
            getContext() {
                var t, e;
            ...
            getTitle(t, e) {
                let { callbacks: i } = e
                    , s = eH(i, "beforeTitle", this, t)
                    , a = eH(i, "title", this, t)
                    , n = eH(i, "afterTitle", this, t)
                    , r = [];
                return r = eA(r, eF(s)),
                    r = eA(r, eF(a)),
                    r = eA(r, eF(n))
            ...
            getBeforeBody(t, e) {
                return eA([], eF(eH(e.callbacks, "beforeBody", this, t)))
            }
            getBody(t, e) {
                let { callbacks: i } = e
                    , a = [];
                return (0,
                    s.F)(t, t => {
                        let e = {
                            ...
                            , s = eB(i, t);
                        eA(e.before, eF(eH(s, "beforeLabel", this, t))),
                            eA(e.lines, eH(s, "label", this, t)),
                            eA(e.after, eF(eH(s, "afterLabel", this, t))),
                            a.push(e)
                    }
                    ),
                    a
            ...
            getAfterBody(t, e) {
                return eA([], eF(eH(e.callbacks, "afterBody", this, t)))
            }
            getFooter(t, e) {
                let { callbacks: i } = e
                    , s = eH(i, "beforeFooter", this, t)
                    , a = eH(i, "footer", this, t)
                    , n = eH(i, "afterFooter", this, t)
                    , r = [];
                return r = eA(r, eF(s)),
                    r = eA(r, eF(a)),
                    r = eA(r, eF(n))
            ...
            _createItems(t) {
                ...
                return t.filter && (h = h.filter((e, i, s) => t.filter(e, i, s, n))),
                    t.itemSort && (h = h.sort((e, i) => t.itemSort(e, i, n))),
                    (0,
                        s.F)(h, e => {
                            let i = eB(t.callbacks, e);
                            r.push(eH(i, "labelColor", this, e)),
                                o.push(eH(i, "labelPointStyle", this, e)),
                                l.push(eH(i, "labelTextColor", this, e))
                        }
                        ),
                    this.labelColors = r,
            ...
            update(t, e) {
                ...
                let s = this.options.setContext(this.getContext())
                    ...
                    , n = [];
                if (a.length) {
                    let t = eT[s.position].call(this, a, this._eventPosition);
                    ...
                    let e = this._size = ez(this, s)
                        , r = Object.assign({}, t, e)
                        , o = eR(this.chart, s, r)
                        , l = eI(s, r, o, this.chart);
            ...
            getCaretPosition(t, e, i) {
                ...
                let { xAlign: d, yAlign: c } = this
                    ...
                    , { topLeft: p, topRight: f, bottomLeft: m, bottomRight: x } = (0,
                        s.aw)(g)
                    , { x: b, y: _ } = t
                    , { width: v, height: y } = e;
                return "center" === c ? (l = _ + y / 2,
                    "left" === d ? (n = (a = b) - u,
                        o = l + u,
                        h = l - u) : (n = (a = b + v) + u,
                            o = l - u,
                            h = l + u),
                    r = a) : (n = "left" === d ? b + Math.max(p, m) + u : "right" === d ? b + v - Math.max(f, x) - u : this.caretX,
                        "top" === c ? (l = (o = _) - u,
                            a = n - u,
                            r = n + u) : (l = (o = _ + y) + u,
                                a = n + u,
            ...
            drawTitle(t, e, i) {
                ...
                if (l) {
                    let h = (0,
                        s.az)(i.rtl, this.x, this.width);
                    for (r = 0,
                        t.x = eV(this, i.titleAlign, i),
            ...
            _drawColorBox(t, e, i, a, n) {
                ...
                if (n.usePointStyle) {
                    ...
                    t.lineWidth = (0,
                        s.i)(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1,
                        t.strokeStyle = r.borderColor,
            ...
            drawBody(t, e, i) {
                let a, n, r, o, l, h, d;
                let { body: c } = this
                    , { bodySpacing: u, bodyAlign: g, displayColors: p, boxHeight: f, boxWidth: m, boxPadding: x } = i
                    , b = (0,
                        s.a0)(i.bodyFont)
                    , _ = b.lineHeight
                    , v = 0
                    , y = (0,
                        s.az)(i.rtl, this.x, this.width)
                    , M = function (i) {
                        e.fillText(i, y.x(t.x + v), t.y + _ / 2),
                            t.y += _ + u
                    }
                    , w = y.textAlign(g);
                for (e.textAlign = g,
                    ...
                    (0,
                        s.F)(this.beforeBody, M),
                    v = p && "right" !== w ? "center" === g ? m / 2 + x : m + 2 + x : 0,
                    o = 0,
                    h = c.length; o < h; ++o) {
                    for (a = c[o],
                        ...
                        (0,
                            s.F)(a.before, M),
                        r = a.lines,
                        p && r.length && (this._drawColorBox(e, t, o, y, i),
            ...
            drawFooter(t, e, i) {
                ...
                if (o) {
                    let l = (0,
                        s.az)(i.rtl, this.x, this.width);
                    for (t.x = eV(this, i.footerAlign, i),
            ...
            _updateAnimationTarget(t) {
                let e = this.chart
                    ...
                    , a = i && i.y;
                if (s || a) {
                    let i = eT[t.position].call(this, this._active, this._eventPosition);
                    if (!i)
                        return;
                    let n = this._size = ez(this, t)
                        , r = Object.assign({}, i, this._size)
                        , o = eR(e, t, r)
                        , l = eI(t, r, o, e);
                    (s._to !== l.x || a._to !== l.y) && (this.xAlign = o.xAlign,
                        this.yAlign = o.yAlign,
                        this.width = n.width,
            ...
            draw(t) {
                ...
                e.enabled && o && (t.save(),
                    ...
                    (0,
                        s.aA)(t, e.textDirection),
                    n.y += r.top,
                    this.drawTitle(n, t, e),
                    this.drawBody(n, t, e),
                    this.drawFooter(n, t, e),
                    (0,
                        s.aC)(t, e.textDirection),
                    t.restore())
            }
            getActiveElements() {
                return this._active || []
            ...
            setActiveElements(t, e) {
                let i = this._active
                    , a = t.map(({ datasetIndex: t, index: e }) => {
                        ...
                        if (!i)
                            throw Error("Cannot find a dataset at index " + t);
                        return {
                            datasetIndex: t,
                            element: i.data[e],
                            index: e
            ...
            handleEvent(t, e, i = !0) {
                ...
                let a = this.options
                    ...
                    , l = e || !(0,
                        s.ah)(r, n) || o;
                return l && (this._active = r,
                    (a.enabled || a.external) && (this._eventPosition = {
                        x: t.x,
                        y: t.y
                    },
                        this.update(!0, e))),
        ...
        var eW = Object.freeze({
            ...
            Colors: {
                ...
                beforeLayout(t, e, i) {
                    ...
                    if (!i.enabled)
                        return;
                    let { data: { datasets: a }, options: n } = t.config
                        , { elements: r } = n;
                    if (!i.forceOverride && (eg(a) || n && (n.borderColor || n.backgroundColor) || r && eg(r)))
                        return;
                    let o = (s = 0,
                        (e, i) => {
                            var a, n, r;
                            let o = t.getDatasetMeta(i).controller;
                            o instanceof L ? (a = s,
                                e.backgroundColor = e.data.map(() => ec(a++)),
                                s = a) : o instanceof O ? (n = s,
                                    e.backgroundColor = e.data.map(() => eu(n++)),
                                    s = n) : o && (r = s,
                                        e.borderColor = ec(r),
                                        e.backgroundColor = eu(r),
                                        s = ++r)
                        }
                    );
                    a.forEach(o)
            ...
            Decimation: {
                ...
                beforeElementsUpdate: (t, e, i) => {
                    ...
                    t.data.datasets.forEach((e, n) => {
                        let r;
                        let { _data: o, indexAxis: l } = e
                            , h = t.getDatasetMeta(n)
                            , d = o || e.data;
                        if ("y" === (0,
                            s.a)([l, t.options.indexAxis]) || !h.controller.supportsDecimation)
                            return;
                        let c = t.scales[h.xAxisID];
                        if ("linear" !== c.type && "time" !== c.type || t.options.parsing)
                            return;
                        let { start: u, count: g } = function (t, e) {
                            let i;
                            let a = e.length
                                , n = 0
                                , { iScale: r } = t
                                , { min: o, max: l, minDefined: h, maxDefined: d } = r.getUserBounds();
                            return h && (n = (0,
                                s.S)((0,
                                    s.B)(e, r.axis, o).lo, 0, a - 1)),
                                i = d ? (0,
                                    s.S)((0,
                                        s.B)(e, r.axis, l).hi + 1, n, a) - n : a - n,
                            {
                                start: n,
                                count: i
                            }
                        }(h, d);
                        if (g <= (i.threshold || 4 * a)) {
                            ep(e);
                            return
                        }
                        switch ((0,
                        ...
                        i.algorithm) {
                            case "lttb":
                                r = function (t, e, i, s, a) {
                                    ...
                                    for (n = 0,
                                        c[g++] = t[f]; n < d - 2; n++) {
                                        let s, a = 0, d = 0, p = Math.floor((n + 1) * u) + 1 + e, m = Math.min(Math.floor((n + 2) * u) + 1, i) + e, x = m - p;
                                        for (s = p; s < m; s++)
                                            a += t[s].x,
                                                d += t[s].y;
                                        a /= x,
                                            d /= x;
                                        let b = Math.floor(n * u) + 1 + e
                                            , _ = Math.min(Math.floor((n + 1) * u) + 1, i) + e
                                            , { x: v, y: y } = t[f];
                                        for (o = l = -1,
                                            s = b; s < _; s++)
                                            (l = .5 * Math.abs((v - a) * (t[s].y - y) - (v - t[s].x) * (d - y))) > o && (o = l,
                                                r = t[s],
                                                h = s);
                                        c[g++] = r,
                                            f = h
                            ...
                            case "min-max":
                                r = function (t, e, i, a) {
                                    let n, r, o, l, h, d, c, u, g, p, f = 0, m = 0, x = [], b = t[e].x, _ = t[e + i - 1].x - b;
                                    for (n = e; n < e + i; ++n) {
                                        o = ((r = t[n]).x - b) / _ * a,
                                            l = r.y;
                                        let e = 0 | o;
            ...
            Filler: {
                        ...
                        r = (a = t.getDatasetMeta(n)).dataset,
                            ...
                            r && r.options && r instanceof t9 && (o = {
                                ...
                                fill: function (t, e, i) {
                                    ...
                                    let o = parseFloat(r);
                                    return (0,
                                        s.g)(o) && Math.floor(o) === o ? (a = r[0],
                                            n = o,
                                            ("-" === a || "+" === a) && (n = e + n),
                                            n !== e && !(n < 0) && !(n >= i) && n) : ["origin", "start", "end", "stack", "shape"].indexOf(r) >= 0 && r
                                }(r, n, l),
                                chart: t,
                            ...
                            h.push(o);
                    for (n = 0; n < l; ++n)
                        (o = h[n]) && !1 !== o.fill && (o.fill = function (t, e, i) {
                            let a;
                            let n = t[e].fill
                                , r = [e];
                            if (!i)
                ...
                beforeDatasetsDraw(t, e, i) {
                    ...
                    for (let e = s.length - 1; e >= 0; --e) {
                        let i = s[e].$filler;
                        ev(i) && eM(t.ctx, i, t.chartArea)
                    }
                },
                beforeDatasetDraw(t, e, i) {
                    let s = e.meta.$filler;
                    ev(s) && "beforeDatasetDraw" === i.drawTime && eM(t.ctx, s, t.chartArea)
                },
                defaults: {
                    propagate: !0,
                    ...
                    labels: {
                        ...
                        generateLabels(t) {
                            let e = t.data.datasets
                                , { labels: { usePointStyle: i, pointStyle: a, textAlign: n, color: r, useBorderRadius: o, borderRadius: l } } = t.legend.options;
        ...
        let e$ = (t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1,
            s.unshift({
                index: i,
                label: e
            })) : isNaN(e) && (i = null),
            i)
            , eU = (t, e) => null === t ? null : (0,
                s.S)(Math.round(t), 0, e);
        function eY(t) {
        ...
        class eQ extends tk {
            ...
            parse(t, e) {
                ...
                return eU(e = isFinite(e) && i[e] === t ? e : function (t, e, i, s) {
                    let a = t.indexOf(e);
                    return -1 === a ? e$(t, e, i, s) : a !== t.lastIndexOf(e) ? i : a
                }(i, t, (0,
                    s.v)(e, t), this._addedLabels), i.length - 1)
            }
            determineDataLimits() {
        ...
        function eX(t, e, { horizontal: i, minRotation: a }) {
            let n = (0,
                s.t)(a)
                , r = .75 * e * ("" + t).length;
        ...
        class eq extends tk {
            ...
            parse(t, e) {
                return (0,
                    s.k)(t) || ("number" == typeof t || t instanceof Number) && !isFinite(+t) ? null : +t
            }
            ...
            getTickLimit() {
                ...
                return i ? (t = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1) > 1e3 && (console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${t} ticks. Limiting to 1000.`),
            ...
            buildTicks() {
                let t = this.options
                    ...
                    , a = function (t, e) {
                        let i, a, n, r;
                        let o = []
                            , { bounds: l, step: h, min: d, max: c, precision: u, count: g, maxTicks: p, maxDigits: f, includeBounds: m } = t
                            , x = h || 1
                            , b = p - 1
                            , { min: _, max: v } = e
                            , y = !(0,
                        ...
                        (r = Math.ceil(v / S) - Math.floor(_ / S)) > b && (S = (0,
                            s.aH)(r * S / b / x) * x),
                            (0,
                                s.k)(u) || (S = Math.ceil(S * (i = Math.pow(10, u))) / i),
                            "ticks" === l ? (a = Math.floor(_ / S) * S,
                                n = Math.ceil(v / S) * S) : (a = _,
                                    n = v),
                            y && M && h && (0,
                                s.aI)((c - d) / h, S / 1e3) ? (r = Math.round(Math.min((c - d) / S, p)),
                                    S = (c - d) / r,
                                    a = d,
                                    n = c) : w ? (a = y ? d : a,
                                        S = ((n = M ? c : n) - a) / (r = g - 1)) : (r = (n - a) / S,
                                            r = (0,
                                                s.aJ)(r, Math.round(r), S / 1e3) ? Math.round(r) : Math.ceil(r));
                        let D = Math.max((0,
                            s.aK)(S), (0,
                                s.aK)(a));
                        a = Math.round(a * (i = Math.pow(10, (0,
                            s.k)(u) ? D : u))) / i,
                            n = Math.round(n * i) / i;
                        let P = 0;
                        for (y && (m && a !== d ? (o.push({
                            ...
                            a < d && P++,
                            (0,
                                s.aJ)(Math.round((a + P * S) * i) / i, d, eX(d, k, t)) && P++) : a < d && P++); P < r; ++P) {
                        ...
                        return M && m && n !== c ? o.length && (0,
                            s.aJ)(o[o.length - 1].value, c, eX(c, k, t)) ? o[o.length - 1].value = c : o.push({
                                value: c
                            }) : M && n !== c || o.push({
                                value: n
                            }),
            ...
            getLabelForValue(t) {
                return (0,
                    s.o)(t, this.chart.options.locale, this.options.ticks.format)
            }
        }
        class eG extends eq {
            static id = "linear";
            ...
            computeTickLimit() {
                let t = this.isHorizontal()
                    ...
                    , i = (0,
                        s.t)(this.options.ticks.minRotation);
        ...
        let eK = t => Math.floor((0,
            s.aM)(t))
            , eJ = (t, e) => Math.pow(10, eK(t) + e);
        function eZ(t) {
            return 1 == t / Math.pow(10, eK(t))
        }
        function e0(t, e, i) {
            let s = Math.pow(10, i);
        ...
        class e1 extends tk {
            ...
            parse(t, e) {
                let i = eq.prototype.parse.apply(this, [t, e]);
                if (0 === i) {
                    this._zero = !0;
                    return
                }
            ...
            determineDataLimits() {
                let { min: t, max: e } = this.getMinMax(!0);
                this.min = (0,
                    s.g)(t) ? Math.max(0, t) : null,
                    this.max = (0,
                        s.g)(e) ? Math.max(0, e) : null,
                    this.options.beginAtZero && (this._zero = !0),
                    this._zero && this.min !== this._suggestedMin && !(0,
                        s.g)(this._userMin) && (this.min = t === eJ(this.min, 0) ? eJ(this.min, -1) : eJ(this.min, 0)),
                    this.handleTickRangeOptions()
            }
            handleTickRangeOptions() {
                let { minDefined: t, maxDefined: e } = this.getUserBounds()
                ...
                let t = this.options
                    , e = function (t, { min: e, max: i }) {
                        ...
                        let a = []
                            ...
                            , g = (0,
                                s.O)(t.min, Math.round((h + c + u * Math.pow(10, r)) * o) / o);
                        for (; g < i;)
                            a.push({
                                value: g,
                                major: eZ(g),
            ...
            getPixelForValue(t) {
                return ((void 0 === t || 0 === t) && (t = this.min),
                    null === t || isNaN(t)) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : ((0,
                        s.aM)(t) - this._startValue) / this._valueRange)
            }
            getValueForPixel(t) {
        ...
        function e2(t) {
            ...
            if (e.display && t.display) {
                let t = (0,
                    s.E)(e.backdropPadding);
                return (0,
                    s.v)(e.font && e.font.size, s.d.font.size) + t.height
            }
            return 0
        }
        function e5(t, e, i, s, a) {
            return t === s || t === a ? {
                start: e - i / 2,
                end: e + i / 2
            } : t < s || t > a ? {
        ...
        function e3(t, e, i, a) {
            let { ctx: n } = t;
            if (i)
                n.arc(t.xCenter, t.yCenter, e, 0, s.T);
            else {
        ...
        class e6 extends eq {
            ...
            setDimensions() {
                let t = this._padding = (0,
                    s.E)(e2(this.options) / 2)
            ...
            computeTickLimit() {
                return Math.ceil(this.drawingArea / e2(this.options))
            }
            generateTickLabels(t) {
                eq.prototype.generateTickLabels.call(this, t),
                    this._pointLabels = this.getLabels().map((t, e) => {
                        let i = (0,
                            s.Q)(this.options.pointLabels.callback, [t, e], this);
                        return i || 0 === i ? i : ""
                    }
                    ...
                    for (let c = 0; c < r; c++) {
                        ...
                        !function (t, e, i, s, a) {
                            let n = Math.abs(Math.sin(i))
                                ...
                                , o = 0
                                , l = 0;
                            s.start < e.l ? (o = (e.l - s.start) / n,
                                t.l = Math.min(t.l, e.l - o)) : s.end > e.r && (o = (s.end - e.r) / n,
                                    t.r = Math.max(t.r, e.r + o)),
                                a.start < e.t ? (l = (e.t - a.start) / r,
                                    t.t = Math.min(t.t, e.t - l)) : a.end > e.b && (l = (a.end - e.b) / r,
                                        t.b = Math.max(t.b, e.b + l))
                        }(i, e, f, e5(m, u.x, p.w, 0, 180), e5(m, u.y, p.h, 90, 270))
                    }
                        ...
                        t._pointLabelItems = function (t, e, i) {
                            ...
                            for (let o = 0; o < r; o++) {
                                ...
                                let r = function (t, e, i) {
                                    var a, n, r, o;
                                    let l = t.drawingArea
                                        , { extra: h, additionalAngle: d, padding: c, size: u } = i
                                        ...
                                        , f = (a = g.y,
                                            n = u.h,
                                            90 === p || 270 === p ? a -= n / 2 : (p > 270 || p < 90) && (a -= n),
                                            a)
                                        , m = 0 === p || 180 === p ? "center" : p < 180 ? "left" : "right"
                                        , x = (r = g.x,
                                            o = u.w,
                                            "right" === m ? r -= o : "center" === m && (r -= o / 2),
                                            r);
                                    return {
                                        visible: !0,
                                        x: g.x,
            ...
            getPointLabelPosition(t) {
                let { left: e, top: i, right: s, bottom: a } = this._pointLabelItems[t];
                return {
                    left: e,
                    top: i,
                    right: s,
            ...
            drawBackground() {
                ...
                if (t) {
                    ...
                    i.save(),
                        i.beginPath(),
                        e3(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                        i.closePath(),
                        i.fillStyle = t,
                        i.fill(),
                        i.restore()
            ...
            drawGrid() {
                ...
                if (n.pointLabels.display && function (t, e) {
                    let { ctx: i, options: { pointLabels: a } } = t;
                    for (let n = e - 1; n >= 0; n--) {
                        ...
                        (0,
                            s.Z)(i, t._pointLabels[n], l, h + o.lineHeight / 2, o, {
                                color: r.color,
                                textAlign: d,
                                textBaseline: "middle"
                            })
                    ...
                    o.display && this.ticks.forEach((t, i) => {
                        if (0 !== i) {
                    ...
                    for (a.save(),
                        ...
                        l && o && (a.lineWidth = l,
                            ...
                            e = this.getDistanceFromCenterForValue(n.ticks.reverse ? this.min : this.max),
                ...
                i.save(),
                    ...
                    this.ticks.forEach((r, o) => {
                        ...
                        let l = n.setContext(this.getContext(o))
                            , h = (0,
                                s.a0)(l.font);
                        if (t = this.getDistanceFromCenterForValue(this.ticks[o].value),
                            l.showLabelBackdrop) {
                            i.font = h.string,
                                e = i.measureText(r.label).width,
                                i.fillStyle = l.backdropColor;
                            let a = (0,
                                s.E)(l.backdropPadding);
        ...
        function e9(t, e) {
            ...
            return ("function" == typeof a && (o = a(o)),
                (0,
                    s.g)(o) || (o = "string" == typeof a ? i.parse(o, a) : i.parse(o)),
                null === o) ? null : (n && (o = "week" === n && ((0,
                    s.x)(r) || !0 === r) ? i.startOf(o, "isoWeek", r) : i.startOf(o, n)),
                    +o)
        }
        function it(t, e, i, s) {
            let a = e7.length;
            for (let n = e7.indexOf(t); n < a - 1; ++n) {
                let t = e4[e7[n]]
        ...
        class is extends tk {
            ...
            init(t, e = {}) {
                let i = t.time || (t.time = {})
                    , a = this._adapter = new V._date(t.adapters.date);
                a.init(e),
                    (0,
                        s.ab)(i.displayFormats, a.formats()),
                    this._parseOpts = {
                        parser: i.parser,
                        round: i.round,
            ...
            parse(t, e) {
                return void 0 === t ? null : e9(this, t)
            }
            beforeLayout() {
                super.beforeLayout(),
                    this._cache = {
            ...
            determineDataLimits() {
                let t = this.options
                    , e = this._adapter
                    , i = t.time.unit || "day"
                    , { min: a, max: n, minDefined: r, maxDefined: o } = this.getUserBounds();
                function l(t) {
                    r || isNaN(t.min) || (a = Math.min(a, t.min)),
                        o || isNaN(t.max) || (n = Math.max(n, t.max))
                }
                r && o || (l(this._getLabelBounds()),
                    ("ticks" !== t.bounds || "labels" !== t.ticks.source) && l(this.getMinMax(!1))),
                    a = (0,
                        s.g)(a) && !isNaN(a) ? a : +e.startOf(Date.now(), i),
                    n = (0,
                        s.g)(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1,
            ...
            buildTicks() {
                ...
                let n = this.min
                    ...
                    , o = (0,
                        s.aO)(a, n, r);
                return this._unit = e.unit || (i.autoSkip ? it(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, a) {
                    for (let n = e7.length - 1; n >= e7.indexOf(i); n--) {
                        let i = e7[n];
                        if (e4[i].common && t._adapter.diff(a, s, i) >= e - 1)
                            return i
                    }
                    return e7[i ? e7.indexOf(i) : 0]
                }(this, o.length, e.minUnit, this.min, this.max)),
                    this._majorUnit = i.major.enabled && "year" !== this._unit ? function (t) {
                        for (let e = e7.indexOf(t) + 1, i = e7.length; e < i; ++e)
                            if (e4[e7[e]].common)
                                return e7[e]
                    }(this._unit) : void 0,
                    this.initOffsets(a),
                    t.reverse && o.reverse(),
                    ii(this, o, this._majorUnit)
            }
            afterAutoSkip() {
            ...
            _generate() {
                ...
                let i = this._adapter
                    ...
                    , r = this.options
                    , o = r.time
                    , l = o.unit || it(o.minUnit, a, n, this._getLabelCapacity(a))
                    , h = (0,
                        s.v)(r.ticks.stepSize, 1)
                    , d = "week" === l && o.isoWeekday
                    , c = (0,
                        s.x)(d) || !0 === d
                    , u = {}
                    , g = a;
                if (c && (g = +i.startOf(g, "isoWeek", d)),
                    g = +i.startOf(g, c ? "day" : l),
                    i.diff(n, a, l) > 1e5 * h)
                    throw Error(a + " and " + n + " are too far apart with stepSize of " + h + " " + l);
                let p = "data" === r.ticks.source && this.getDataTimestamps();
                for (t = g,
                    e = 0; t < n; t = +i.add(t, h, l),
                    e++)
                    ie(u, t, p);
                return (t === n || "ticks" === r.bounds || 1 === e) && ie(u, t, p),
                    Object.keys(u).sort(e8).map(t => +t)
            }
            getLabelForValue(t) {
                let e = this._adapter
                    , i = this.options.time;
            ...
            _getLabelSize(t) {
                let e = this.options.ticks
                    ...
                    , a = (0,
                        s.t)(this.isHorizontal() ? e.maxRotation : e.minRotation)
                    , n = Math.cos(a)
                    , r = Math.sin(a)
            ...
            _getLabelCapacity(t) {
                let e = this.options.time
                    ...
                    , a = this._tickFormatFunction(t, 0, ii(this, [t], this._majorUnit), s)
        ...
        function ia(t, e, i) {
            let a, n, r, o, l = 0, h = t.length - 1;
            i ? (e >= t[l].pos && e <= t[h].pos && ({ lo: l, hi: h } = (0,
                s.B)(t, "pos", e)),
                { pos: a, time: r } = t[l],
                { pos: n, time: o } = t[h]) : (e >= t[l].time && e <= t[h].time && ({ lo: l, hi: h } = (0,
                    s.B)(t, "time", e)),
                    { time: a, pos: r } = t[l],
                    { time: n, pos: o } = t[h]);
            let d = n - a;
        ...
        class ir extends is {
            ...
            initOffsets() {
                ...
                this._minPos = ia(e, this.min),
                    this._tableRange = ia(e, this.max) - this._minPos,
                    super.initOffsets(t)
            }
            buildLookupTable(t) {
                let e, i, s;
                ...
                for (e = 0,
                    i = r.length; e < i; ++e)
                    Math.round((r[e + 1] + r[e - 1]) / 2) !== (s = r[e]) && o.push({
                        time: s,
                        pos: e / (i - 1)
                    });
                return o
            ...
            getValueForPixel(t) {
                let e = this._offsets
                    , i = this.getDecimalForPixel(t) / e.factor - e.end;
                return ia(this._table, i * this._tableRange + this._minPos, !0)
            }
        }
        let io = [z, el, eW, Object.freeze({
            __proto__: null,
            CategoryScale: eQ,
            LinearScale: eG,
            LogarithmicScale: e1,
            RadialLinearScale: e6,
            TimeScale: is,
            TimeSeriesScale: ir
        })]
    }
